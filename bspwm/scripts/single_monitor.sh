...
then
    xrandr --output eDP-1 --off --output DP-1 --off --output HDMI-1 --off --output HDMI-1-0 --primary --mode 1920x1080 --pos 1920x0 --rotate normal --rate 74.97 --output DP-1-0 --off --output DP-1-1 --off
